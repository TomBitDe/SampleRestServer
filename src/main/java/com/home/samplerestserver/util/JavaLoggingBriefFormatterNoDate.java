 ...
 * <p>
 * 10:10:06:732 root[INFO|main]: This is the log message
 */
public class JavaLoggingBriefFormatterNoDate extends Formatter {
    /**
     * The default date format to use in the log message.
     */
    private static final String DATE_FORMAT_DEFAULT = "h:mm:ss.SSS";
    /**
